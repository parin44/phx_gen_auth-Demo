defmodule AuthSystemWeb.UserAuthTest do
  use AuthSystemWeb.ConnCase, async: true

  alias AuthSystem.Accounts
  alias AuthSystemWeb.UserAuth
  import AuthSystem.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, AuthSystemWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      AuthSystemWeb.Endpoint.subscribe(live_socket_id)
